...
if __name__ == "__main__":
    input_path = "data/0_source_datasets/coco_eval_questions.json"
    output_path = "data/1_question_datasets/coco_questions.json"

    transformer = COCODatasetTransformer(input_path, output_path)
    transformer.run()